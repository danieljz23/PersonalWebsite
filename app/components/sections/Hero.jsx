...
const floatingLabelPositions = [
  { top: "6%", left: "-20%", duration: 8, delay: 0.6, drift: 4 },
  { top: "14%", right: "-30%", duration: 7, delay: 0, drift: 5 },
  { top: "50%", left: "50%", duration: 9, delay: 2, drift: 4 },
  { top: "30%", right: "29%", duration: 8, delay: 1.2, drift: 5 },
];
...
export default function Hero() {
  ...
  const labelConfig = floatingLabelPositions.map((position, index) => ({
    ...position,
    label: floatingLabels[index] ?? "",
  }));
    ...
    >
      <div className="mx-auto max-w-6xl px-6 w-full">
        <div className="relative grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <FloatingLabels labels={labelConfig} reduced={reduced} />
